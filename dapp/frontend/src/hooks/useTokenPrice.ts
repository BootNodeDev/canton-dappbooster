...
// A live fetch would add a rate-limited network dependency to a mock-first app for one cosmetic
// line, so the rate is a dated constant behind the interface a real one will satisfy.
