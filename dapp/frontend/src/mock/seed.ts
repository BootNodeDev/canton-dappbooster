...
export const seedView = (nowMs: number = now()): VestingView => ({
  grants: [
    ...
    },
    {
      ...
      creator: PARTY.dave,
      receiver: PARTY.bob,
      // Full-precision total on the fully-vested grant: exercises the exact path end to end,
      // vested included, since a 100%-vested grant must return the total to the digit.
      totalAmount: '8421337.1234567891',
      schedule: linear(nowMs, -400, -35),
      alreadyWithdrawn: '10000',
      note: 'Fully vested',
    },
    {
      id: 'seed-grant-cliff',
